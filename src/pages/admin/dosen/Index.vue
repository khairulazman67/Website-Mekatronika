                                ...
                                <div class=" bg-white rounded-b-3xl shadow-lg py-2">
                                    <div
                                        ...
                                        <div class="w-full bg-white rounded-3xl mt-5 p-5">
                                            <router-link :to="{name:'formdosen',params:{id:'create'}}" class="mt-4">
                                                <button type="submit"
                                                class="bg-green-500 mt-2 hover:bg-green-600 text-white font-semibold py-1 px-5 rounded-xl ml-2">Tambah Data
                                                </button>
                                            </router-link>
